...
//                         <div className="font-display text-lg sm:text-xl leading-none drop-shadow-[0_0_18px_rgba(214,175,97,0.18)]">
//                             {(() => {
//                                 // supports: "Groom × Bride" OR "Groom x Bride"
//                                 const parts = couple.split(/×|x|X/).map((s) => s.trim()).filter(Boolean);

//                                 // if separator नहीं मिला तो as-it-is दिखा दो
...
//                     {/* ✅ Premium scrolling ticker with event-wise glow */}
//                     <div className="relative mt-3 overflow-hidden rounded-xl border border-white/10 bg-white/5 py-2">
//                         {/* fade edges */}
...
//                         {/* <div className="flex whitespace-nowrap will-change-transform animate-[ticker_22s_linear_infinite]">
//                             <TickerRow events={events} />
//                             <TickerRow events={events} />
//                         </div> */}
//                         <div className="tickerTrack flex whitespace-nowrap will-change-transform">
//                             <div className="tickerRow flex items-center whitespace-nowrap">
//                                 <TickerRow events={events} />
//                                 <TickerRow events={events} />
//                                 <TickerRow events={events} />
//                             </div>
...
//                     <style jsx>{`
//                         .tickerTrack {
//                             animation: tickerMove 12s cubic-bezier(0.16,1,0.3,1) infinite; /* ✅ FAST (pehle 22s) */
//                         }

//                         /* Move full width of the duplicated row */
...
//     events?: TickerEvent[];
// }) {
//     // ✅ Safe events (ticker always has content)
...
//     // ✅ Pause-on-touch state (press/hold)
...
//                             {(() => {
//                                 // supports: "Groom × Bride" OR "Groom x Bride"
//                                 const parts_toggle = couple
//                                     .split(/×|x|X/)
//                                     .map((s) => s.trim())
//                                     .filter(Boolean);

//                                 if (parts_toggle.length < 2) return <span>{couple}</span>;

//                                 return (
//                                     <span className="inline-flex items-center justify-center flex-wrap gap-y-1">
//                                         <span>{parts_toggle[0]}</span>
//                                         <CoupleMark className="text-base sm:text-lg" />
//                                         <span>{parts_toggle.slice(1).join(" ")}</span>
//                                     </span>
//                                 );
//                             })()}
//                         </div>
...
//                     {/* ✅ Premium scrolling ticker (FIXED: always moves left) + Pause-on-touch */}
//                     <div
//                         className="relative mt-3 overflow-hidden rounded-xl border border-white/10 bg-white/5 py-2 select-none"
//                         onMouseEnter={() => setTickerPaused(true)} // desktop hover pause
//                         onMouseLeave={() => setTickerPaused(false)}
//                         onTouchStart={() => setTickerPaused(true)} // mobile press pause
//                         onTouchEnd={() => setTickerPaused(false)}
//                         onTouchCancel={() => setTickerPaused(false)}
//                         onPointerDown={() => setTickerPaused(true)} // pointer support
...
//                         {/* ✅ IMPORTANT: w-max rail + translateX(-50%) = seamless loop */}
//                         <div
//                             className={`tickerRail flex w-max whitespace-nowrap will-change-transform ${tickerPaused ? "tickerPaused" : ""
//                                 }`}
//                             aria-label="Events ticker"
//                         >
...
//                         <style jsx>{`
//               .tickerRail {
//                 animation: luxTicker 12s linear infinite; /* ✅ fast */
//               }
//               .tickerPaused {
